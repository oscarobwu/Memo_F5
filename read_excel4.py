...
#===============================================================================
#
#         Filename:       read_excel4.py
#
#        USAGE: read_excel4.py
#
#  DESCRIPTION: 
#
#      OPTIONS: ---
...
# ORGANIZATION: 
#      VERSION: 1.0
#      Created Time: 2021-01-08 15:58:43
#      Last modified: 2021-01-08 16:52
#     REVISION: ---
#===============================================================================
import pandas as pd
#Insert complete path to the excel file and index of the worksheet
df = pd.read_excel("2021-01-07-18-03_vs_pool.xlsx", sheet_name='10.100.0.22')
...
for x,y in zip(list1, list2):
        ...
        if x == VIP_inupt:
                ...
                for t in g:
                        count = count + 1
                        print("VIP : {} pool_member_({}): {} ".format(x, count, t))
